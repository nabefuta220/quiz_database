...
urlpatterns = [
    ...
    path('answer/next/tag=<str:tagname>,round=<int:round>', views.Quiz_check, name='next'),
    #/quiz/question/tag=[tagname],round=[round]
    path('form/check/tag=<str:tagname>,round=<int:round>',views.serve_problem, name='check'),
]
